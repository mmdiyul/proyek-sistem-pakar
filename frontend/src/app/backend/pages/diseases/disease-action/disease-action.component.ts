...
@Component({
  selector: 'app-disease-action',
  templateUrl: './disease-action.component.html',
  styleUrls: ['./disease-action.component.scss']
})
export class DiseaseActionComponent implements OnInit {
  ...
  onBack(): void {
    this.router.navigate(['/backend/diseases']);
  }
